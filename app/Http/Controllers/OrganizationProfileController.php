...
class OrganizationProfileController extends Controller
{
    ...
    public function update(Request $request, OrganizationProfile $organizationProfile): RedirectResponse
    {
        $validated = $this->validateProfile($request, $organizationProfile->id);
        $validated['updated_by'] = auth()->id();
