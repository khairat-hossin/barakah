...
<style>
    ...
    .border-box { border: 1.5px solid #198754; border-radius: 6px; padding: 16px 20px; box-sizing: border-box; height: 276mm; }
...
<body>
    <div class="border-box">
        @include('pdf.partials.header', ['org' => $org, 'title' => 'DEPOSIT RECEIPT', 'color' => '#198754'])
