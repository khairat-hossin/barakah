                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="form-floating">
                            <select class="form-select @error('payment_method') is-invalid @enderror" id="payment_method" name="payment_method" required>
                                ...
                                <option value="bank_transfer" @selected(old('payment_method', $deposit->payment_method) == 'bank_transfer')>Bank Transfer</option>
                                <option value="check" @selected(old('payment_method', $deposit->payment_method) == 'check')>Check</option>
                                <option value="mobile_banking" @selected(old('payment_method', $deposit->payment_method) == 'mobile_banking')>Mobile Banking</option>
                                <option value="other" @selected(old('payment_method', $deposit->payment_method) == 'other')>Other</option>
                            </select>
