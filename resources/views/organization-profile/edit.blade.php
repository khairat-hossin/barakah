...
@section('title', 'Edit Organization Profile | ' . \App\Support\Branding::name())
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="organization_name_bn" name="organization_name_bn" value="{{ old('organization_name_bn', $profile->organization_name_bn) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                                <label for="organization_name_en" class="form-label">Organization Name (English) *</label>
                                <input type="text" class="form-control" id="organization_name_en" name="organization_name_en" value="{{ old('organization_name_en', $profile->organization_name_en) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-4">
                                <label for="short_name" class="form-label">Short Name *</label>
                                <input type="text" class="form-control" id="short_name" name="short_name" value="{{ old('short_name', $profile->short_name) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-4">
                                <label for="registration_number" class="form-label">Registration Number *</label>
                                <input type="text" class="form-control" id="registration_number" name="registration_number" value="{{ old('registration_number', $profile->registration_number) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control" id="mobile_number" name="mobile_number" value="{{ old('mobile_number', $profile->mobile_number) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="url" class="form-control" id="website" name="website" value="{{ old('website', $profile->website) }}">
                            </div>
                            <div class="col-md-6">
                                <label for="secondary_mobile" class="form-label">Secondary Mobile</label>
                                <input type="tel" class="form-control" id="secondary_mobile" name="secondary_mobile" value="{{ old('secondary_mobile', $profile->secondary_mobile) }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="address_line" name="address_line" rows="2" required>{{ old('address_line', $profile->address_line) }}</textarea>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                                <label for="village_area" class="form-label">Village/Area *</label>
                                <input type="text" class="form-control" id="village_area" name="village_area" value="{{ old('village_area', $profile->village_area) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                                <label for="post_office" class="form-label">Post Office *</label>
                                <input type="text" class="form-control" id="post_office" name="post_office" value="{{ old('post_office', $profile->post_office) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                                <label for="union_ward" class="form-label">Union/Ward *</label>
                                <input type="text" class="form-control" id="union_ward" name="union_ward" value="{{ old('union_ward', $profile->union_ward) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                                <label for="upazila" class="form-label">Upazila *</label>
                                <input type="text" class="form-control" id="upazila" name="upazila" value="{{ old('upazila', $profile->upazila) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                                <label for="district" class="form-label">District *</label>
                                <input type="text" class="form-control" id="district" name="district" value="{{ old('district', $profile->district) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                                <label for="division" class="form-label">Division</label>
                                <input type="text" class="form-control" id="division" name="division" value="{{ old('division', $profile->division) }}">
                            </div>
                            <div class="col-md-6">
                                <label for="postal_code" class="form-label">Postal Code *</label>
                                <input type="text" class="form-control" id="postal_code" name="postal_code" value="{{ old('postal_code', $profile->postal_code) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="motto" name="motto" value="{{ old('motto', $profile->motto) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-12">
                                <label for="vision_statement" class="form-label">Vision Statement *</label>
                                <textarea class="form-control" id="vision_statement" name="vision_statement" rows="3" required>{{ old('vision_statement', $profile->vision_statement) }}</textarea>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-12">
                                <label for="mission_statement" class="form-label">Mission Statement *</label>
                                <textarea class="form-control" id="mission_statement" name="mission_statement" rows="3" required>{{ old('mission_statement', $profile->mission_statement) }}</textarea>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-12">
                                <label for="about_organization" class="form-label">About Organization</label>
                                <textarea class="form-control" id="about_organization" name="about_organization" rows="3">{{ old('about_organization', $profile->about_organization) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="total_shares" name="total_shares" value="{{ old('total_shares', $profile->total_shares) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                                <label for="share_face_value" class="form-label">Share Face Value (BDT) *</label>
                                <input type="number" step="0.01" class="form-control" id="share_face_value" name="share_face_value" value="{{ old('share_face_value', $profile->share_face_value) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="minimum_shares_per_member" name="minimum_shares_per_member" value="{{ old('minimum_shares_per_member', $profile->minimum_shares_per_member) }}" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                                <label for="maximum_shares_per_member" class="form-label">Maximum Shares Per Member</label>
                                <input type="number" class="form-control" id="maximum_shares_per_member" name="maximum_shares_per_member" value="{{ old('maximum_shares_per_member', $profile->maximum_shares_per_member) }}">
                            </div>
                            <div class="col-12">
