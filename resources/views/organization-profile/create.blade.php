...
<div class="mb-9">
    ...
    <form action="{{ route('organization-profile.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="tab-content">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('organization_name_bn') is-invalid @enderror" id="organization_name_bn" name="organization_name_bn" value="{{ old('organization_name_bn') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('organization_name_en') is-invalid @enderror" id="organization_name_en" name="organization_name_en" value="{{ old('organization_name_en') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('organization_type') is-invalid @enderror" id="organization_type" name="organization_type" required>
                                    ...
                                    <option value="coop" @selected(old('organization_type') == 'coop')>Cooperative</option>
                                    <option value="ngo" @selected(old('organization_type') == 'ngo')>NGO</option>
                                    <option value="mutual" @selected(old('organization_type') == 'mutual')>Mutual Society</option>
                                    <option value="association" @selected(old('organization_type') == 'association')>Association</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control @error('mobile_number') is-invalid @enderror" id="mobile_number" name="mobile_number" value="{{ old('mobile_number') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control @error('secondary_mobile') is-invalid @enderror" id="secondary_mobile" name="secondary_mobile" value="{{ old('secondary_mobile') }}">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('address_line') is-invalid @enderror" id="address_line" name="address_line" rows="2" required>{{ old('address_line') }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('village_area') is-invalid @enderror" id="village_area" name="village_area" value="{{ old('village_area') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('union_ward') is-invalid @enderror" id="union_ward" name="union_ward" value="{{ old('union_ward') }}" required>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control @error('motto') is-invalid @enderror" id="motto" name="motto" value="{{ old('motto') }}" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('vision_statement') is-invalid @enderror" id="vision_statement" name="vision_statement" rows="3" required>{{ old('vision_statement') }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('mission_statement') is-invalid @enderror" id="mission_statement" name="mission_statement" rows="3" required>{{ old('mission_statement') }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('about_organization') is-invalid @enderror" id="about_organization" name="about_organization" rows="3">{{ old('about_organization') }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('total_shares') is-invalid @enderror" id="total_shares" name="total_shares" value="{{ old('total_shares') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" class="form-control @error('share_face_value') is-invalid @enderror" id="share_face_value" name="share_face_value" value="{{ old('share_face_value') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('minimum_shares_per_member') is-invalid @enderror" id="minimum_shares_per_member" name="minimum_shares_per_member" value="{{ old('minimum_shares_per_member', 1) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('maximum_shares_per_member') is-invalid @enderror" id="maximum_shares_per_member" name="maximum_shares_per_member" value="{{ old('maximum_shares_per_member') }}">
                                @error('maximum_shares_per_member') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="share_transfer_allowed" name="share_transfer_allowed" value="1" @checked(old('share_transfer_allowed', true))>
            ...
            <!-- Remaining sections: Membership, Committee, Financial, Meetings -->
            <!-- (Abbreviated for brevity - similar structure to above sections) -->
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="membership_type" name="membership_type" required>
                                    <option value="share_based" @selected(old('membership_type') == 'share_based')>Share-Based</option>
                                    <option value="open" @selected(old('membership_type') == 'open')>Open</option>
                                    <option value="invitation_only" @selected(old('membership_type') == 'invitation_only')>Invitation Only</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label for="minimum_share_requirement" class="form-label">Minimum Share Requirement *</label>
                                <input type="number" class="form-control" id="minimum_share_requirement" name="minimum_share_requirement" value="{{ old('minimum_share_requirement', 0) }}" required>
                            </div>
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="new_member_admission_allowed" name="new_member_admission_allowed" value="1" @checked(old('new_member_admission_allowed', true))>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="committee_term_length" name="committee_term_length" value="{{ old('committee_term_length', 3) }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="maximum_consecutive_terms" class="form-label">Maximum Consecutive Terms *</label>
                                <input type="number" class="form-control" id="maximum_consecutive_terms" name="maximum_consecutive_terms" value="{{ old('maximum_consecutive_terms', 2) }}" required>
                            </div>
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="election_required" name="election_required" value="1" @checked(old('election_required', true))>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="default_currency" name="default_currency" value="{{ old('default_currency', 'BDT') }}" maxlength="3" required>
                            </div>
                            <div class="col-md-6">
                                <label for="reserve_fund_percentage" class="form-label">Reserve Fund Percentage *</label>
                                <input type="number" step="0.01" class="form-control" id="reserve_fund_percentage" name="reserve_fund_percentage" value="{{ old('reserve_fund_percentage', 10) }}" required>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="general_meeting_notice_days" name="general_meeting_notice_days" value="{{ old('general_meeting_notice_days', 7) }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="general_meeting_quorum_percentage" class="form-label">General Meeting Quorum (%) *</label>
                                <input type="number" class="form-control" id="general_meeting_quorum_percentage" name="general_meeting_quorum_percentage" value="{{ old('general_meeting_quorum_percentage', 50) }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="committee_meeting_notice_days" class="form-label">Committee Meeting Notice Period (Days) *</label>
                                <input type="number" class="form-control" id="committee_meeting_notice_days" name="committee_meeting_notice_days" value="{{ old('committee_meeting_notice_days', 3) }}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="minimum_committee_meetings_per_year" class="form-label">Minimum Committee Meetings Per Year *</label>
                                <input type="number" class="form-control" id="minimum_committee_meetings_per_year" name="minimum_committee_meetings_per_year" value="{{ old('minimum_committee_meetings_per_year', 12) }}" required>
                            </div>
                        </div>
                    </div>
                </div>
                <button type="button" class="btn btn-outline-secondary" onclick="document.querySelector('#financial-tab').click()">← Back</button>
                <button type="submit" class="btn btn-success float-end">✓ Create Organization Profile</button>
            </div>
        </div>
    </form>
</div>
