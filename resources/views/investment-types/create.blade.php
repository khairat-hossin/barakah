...
@section('title', 'Create Investment Type | ' . \App\Support\Branding::name())
...
<div class="mb-9">
    <div class="row align-items-center justify-content-between mb-3">
        <div class="col">
            <h2 class="mb-0">Create Investment Type</h2>
            <p class="text-body-secondary">Add a new investment type to the system</p>
        </div>
    </div>

    <form method="POST" action="{{ route('investment-types.store') }}">
        @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <select class="form-select @error('default_return_type') is-invalid @enderror"
                                ...
                                <option value="fixed" @selected(old('default_return_type') === 'fixed')>Fixed</option>
                                <option value="variable" @selected(old('default_return_type') === 'variable')>Variable</option>
                                <option value="dividend" @selected(old('default_return_type') === 'dividend')>Dividend</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input class="form-control @error('default_tenure_months') is-invalid @enderror"
                                   ...
                                   placeholder="Months"
                                   value="{{ old('default_tenure_months') }}" min="0" />
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input class="form-control @error('min_investment_amount') is-invalid @enderror"
                                   ...
                                   placeholder="0.00"
                                   value="{{ old('min_investment_amount') }}" step="0.01" min="0" />
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input class="form-control @error('max_investment_amount') is-invalid @enderror"
                                   ...
                                   placeholder="0.00"
                                   value="{{ old('max_investment_amount') }}" step="0.01" min="0" />
                    ...
                    <div class="col-12">
                        <div class="form-check">
                            <input class="form-check-input @error('requires_approval') is-invalid @enderror"
                                   ...
                                   value="1" @checked(old('requires_approval')) />
        ...
        <div class="mt-3">
            <button class="btn btn-primary" type="submit">
                <span class="fas fa-save me-2"></span>Create Investment Type
            </button>
