...
Route::get('/api/member/{member}/deposit-info', function (\App\Models\Member $member) {
    ...
    $paidMonths = $member->depositMonths()
        ->get()
...
// Quick Deposit API Route
Route::post('/api/deposits/quick', [SavingsEntryController::class, 'quickStore'])
...
Route::middleware(['auth', 'can:view expenses'])
    ...
    ->group(function (): void {
        ...
        Route::post('/{expense}/send-receipt', [ExpenseController::class, 'sendReceipt'])->name('send-receipt');
