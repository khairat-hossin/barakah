<?php $__env->startSection('title', 'Expenses | Barakah'); ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h4 class="mb-0">৳ <?php echo e(number_format($totalExpenses, 0)); ?></h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h4 class="mb-0">৳ <?php echo e(number_format($monthlyExpenses, 0)); ?></h4>
                        </div>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <div class="card summary-card bg-body-highlight border-start border-info border-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-body-secondary fs-9 mb-2">Count</p>
                            <h4 class="mb-0"><?php echo e($expenses->count()); ?></h4>
                        </div>
                        <span class="badge badge-phoenix badge-phoenix-info rounded-pill">Records</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-3 mb-4 align-items-center">
                ...
                <div class="col-auto">
                    <select class="form-select form-select-sm" id="filterFundSource" style="width: 150px;">
                        ...
                        <?php $__currentLoopData = $fundSources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-auto ms-auto">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage expenses')): ?>
                        <a href="<?php echo e(route('expense-categories.index')); ?>" class="btn btn-outline-secondary btn-sm ms-2">
...
<?php echo $__env->make('layouts.phoenix', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Volumes/Works/kinvest/barakah/resources/views/expenses/index.blade.php ENDPATH**/ ?>