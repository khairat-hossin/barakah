<?php $__env->startSection('title', 'Record Deposit | Barakah'); ?>

<?php $__env->startSection('content'); ?>
<nav class="mb-3" aria-label="breadcrumb">
    <ol class="breadcrumb mb-0">
        <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="<?php echo e(route('deposits.index')); ?>">Deposits</a></li>
...
<div class="mb-9">
    ...
    <form method="POST" action="<?php echo e(route('deposits.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select <?php $__errorArgs = ['member_id'];
...
unset($__errorArgs, $__bag); ?>" id="member_id" name="member_id" required>
                                <option value="">Choose a member...</option>
                                <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($member->id); ?>" <?php if(old('member_id') == $member->id): echo 'selected'; endif; ?>>
                                        <?php echo e($member->name); ?> (<?php echo e($member->member_code); ?>)
                                    </option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control form-control-lg <?php $__errorArgs = ['amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="number" id="amount" name="amount" readonly placeholder="0.00" value="<?php echo e(old('amount', '0.00')); ?>" step="0.01" />
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control <?php $__errorArgs = ['deposit_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="date" id="deposit_date" name="deposit_date" value="<?php echo e(old('deposit_date', date('Y-m-d'))); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control <?php $__errorArgs = ['transaction_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="text" id="transaction_id" name="transaction_id" placeholder="e.g., TXN123456" value="<?php echo e(old('transaction_id')); ?>" />
...
unset($__errorArgs, $__bag); ?>" id="notes" name="notes" placeholder="Add any additional notes..." style="min-height: 100px;"><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" type="file" id="attachments" name="attachments[]" multiple accept=".pdf,.jpg,.jpeg,.png,.doc,.docx" />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row g-3">
            ...
            <div class="col-auto">
                <a class="btn btn-secondary" href="<?php echo e(route('deposits.index')); ?>">Cancel</a>
            </div>
        </div>
    </form>
</div>
...
<?php echo $__env->make('layouts.phoenix', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Volumes/Works/kinvest/barakah/resources/views/deposits/create.blade.php ENDPATH**/ ?>