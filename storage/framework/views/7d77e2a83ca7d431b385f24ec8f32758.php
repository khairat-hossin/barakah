<?php $__env->startSection('title', 'Setup Organization Profile | Barakah'); ?>
...
<div class="mb-9">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="general" role="tabpanel">
            <form id="generalForm" class="section-form" action="<?php echo e(route('organization-profile.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="card mb-4">
        ...
        <div class="tab-pane fade" id="address" role="tabpanel">
            <form id="addressForm" class="section-form" action="<?php echo e(route('organization-profile.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="card mb-4">
...
document.querySelectorAll('.section-form').forEach(form => {
    form.addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch('<?php echo e(route("organization-profile.store")); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.phoenix', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Volumes/Works/kinvest/barakah/resources/views/organization-profile/create.blade.php ENDPATH**/ ?>