<?php $__env->startSection('title', 'Members | Barakah'); ?>
            ...
            <div class="card summary-card bg-body-highlight border-start border-success border-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <span class="badge badge-phoenix badge-phoenix-success rounded-pill"><?php echo e(number_format($members->count())); ?></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h4 class="mb-0"><?php echo e($statusCounts['active']); ?></h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h4 class="mb-0"><?php echo e($statusCounts['inactive']); ?></h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h4 class="mb-0"><?php echo e($statusCounts['suspended']); ?></h4>
                        </div>
            ...
            <div class="row g-3 mb-4 align-items-center">
                ...
                <div class="col-auto ms-auto">
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('members.import-form')); ?>" class="btn btn-outline-primary btn-sm">
                            <span class="fas fa-file-import me-2"></span>Import
                        </a>
                        <a href="<?php echo e(route('members.create')); ?>" class="btn btn-primary btn-sm">
...
$(document).ready(function() {
    ...
    var table = $('#membersTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo e(route("members.datatable")); ?>',
            type: 'GET',
            data: function(d) {
...
<?php echo $__env->make('layouts.phoenix', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Volumes/Works/kinvest/barakah/resources/views/members/index.blade.php ENDPATH**/ ?>