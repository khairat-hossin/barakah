        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card" style="border-left: 4px solid #198754 !important;">
                <div class="card-body p-3">
                    ...
                    <h5 class="mb-1"><?php echo e($totalMembers); ?></h5>
                    <small class="text-body-secondary"><?php echo e($activeMembers); ?> active</small>
                    <?php if($memberGrowth !== 0): ?>
                        <div class="mt-1"><span class="badge <?php echo e($memberGrowth > 0 ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger'); ?>"><?php echo e($memberGrowth > 0 ? '↑' : '↓'); ?> <?php echo e(abs($memberGrowth)); ?>%</span></div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card" style="border-left: 4px solid #0dcaf0 !important;">
                <div class="card-body p-3">
                    ...
                    <h5 class="mb-1"><?php echo e(number_format($totalShares)); ?></h5>
                    <small class="text-body-secondary"><?php echo e(number_format($allocatedShares)); ?> allocated</small>
                    <div class="mt-1"><span class="badge bg-light text-dark" style="font-size: 0.7rem;"><?php echo e(number_format($availableShares)); ?> free</span></div>
                </div>
            </div>
        </div>
            ...
            <div class="card" style="border-left: 4px solid #0d6efd !important;">
                <div class="card-body p-3">
                    ...
                    <?php if($depositChange !== 0): ?>
                        <div class="mt-1"><span class="badge <?php echo e($depositChange > 0 ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger'); ?>"><?php echo e($depositChange > 0 ? '↑' : '↓'); ?> <?php echo e(abs($depositChange)); ?>%</span></div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <div class="card" style="border-left: 4px solid #dc3545 !important;">
                <div class="card-body p-3">
                    ...
                    <?php if($expenseChange !== 0): ?>
                        <div class="mt-1"><span class="badge <?php echo e($expenseChange > 0 ? 'bg-danger-subtle text-danger' : 'bg-success-subtle text-success'); ?>"><?php echo e($expenseChange > 0 ? '↑' : '↓'); ?> <?php echo e(abs($expenseChange)); ?>%</span></div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
