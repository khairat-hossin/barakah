            ...
            <div class="card" style="border-left: 4px solid #198754 !important;">
                <div class="card-body p-3">
                    ...
                    <?php if($memberGrowth !== 0): ?>
                        <div class="mt-1"><span class="badge <?php echo e($memberGrowth > 0 ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger'); ?>"><?php echo e($memberGrowth > 0 ? '↑' : '↓'); ?> <?php echo e(number_format(abs($memberGrowth), 2)); ?>%</span></div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
